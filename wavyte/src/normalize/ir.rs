...
use crate::effects::binding::EffectBindingIR;
...
pub(crate) struct RegistryBindings {
    ...
    pub(crate) effect_kind_by_intern: Vec<Option<crate::foundation::ids::EffectKindId>>,

    pub(crate) param_intern_by_id: Vec<InternId>,
    /// Dense map: `InternId.0 as usize -> Some(ParamId)`.
    pub(crate) param_id_by_intern: Vec<Option<crate::foundation::ids::ParamId>>,
}
...
pub(crate) struct ExprSourceIR {
    pub(crate) target: crate::foundation::ids::PropertyId,
