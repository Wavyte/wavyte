use crate::audio::manifest::build_audio_manifest;
use crate::audio::mix::{mix_manifest, write_mix_to_f32le_file};
use crate::compile::compiler::compile_frame;
use crate::compile::fingerprint::{FrameFingerprint, fingerprint_eval};
...
use crate::normalize::ir::NormalizedComposition;
use crate::normalize::pass::normalize;
use crate::render::backend::FrameRGBA;
use crate::render::backend::RenderBackendV03;
use crate::render::cpu::{CpuBackendOpts, CpuBackendV03};
...
impl RenderSession {
    ...
    pub(crate) fn ir(&self) -> &crate::normalize::ir::CompositionIR {
        &self.norm.ir
    }

    pub(crate) fn interner(&self) -> &crate::normalize::intern::StringInterner {
        &self.norm.interner
    }
...
struct ParallelChunkCtx<'a> {
    ir: &'a crate::normalize::ir::CompositionIR,
    interner: &'a crate::normalize::intern::StringInterner,
...
mod tests {
    ...
    use crate::scene::composition::Composition;
    use crate::scene::model::{AssetDef, CanvasDef, CompositionDef, FpsDef, NodeDef, NodeKindDef};
