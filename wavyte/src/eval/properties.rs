...
use crate::expression::bytecode::TimeField;
use crate::expression::program::{ExprProgram, PropertyProgram, ValueType};
use crate::expression::vm::{ValueSlot, VmError, eval_program_with_stack};
use crate::foundation::ids::{NodeIdx, PropertyId, VarId};
use crate::foundation::math::Fnv1a64;
use crate::normalize::ir::{CompositionIR, VarValueIR};
...
mod tests {
    ...
    fn time_progress_hits_1_at_end_boundary_even_when_out_of_range() {
        ...
        let a_idx = *norm
            ...
            .unwrap();
        let pid =
            crate::normalize::property::PropertyIndex::property_id(a_idx, PropertyKey::Opacity);
