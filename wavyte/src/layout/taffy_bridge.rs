use crate::animation::anim::{Anim, SampleCtx};
...
use crate::normalize::ir::{AssetIR, CompositionIR, NodeKindIR};
...
impl TaffyBridge {
    ...
    pub(crate) fn update_styles_for_frame(
        ...
        node_visible: &[bool],
    ) -> Result<bool, crate::expression::vm::VmError> {
        ...
        for (i, maybe) in self.node_to_taffy.iter().enumerate() {
            ...
            let t = time_ctxs
                .get(i)
                .copied()
                .ok_or_else(|| crate::expression::vm::VmError::new("layout time ctx OOB"))?;
                ...
                != hash
            {
                ...
                self.taffy
                    .set_style(*nid, style)
                    .map_err(|e| crate::expression::vm::VmError::new(e.to_string()))?;
            }
        }
        Ok(dirty)
    }
...
fn style_for_node_and_hash(
    ...
    props: Option<&PropertyValues>,
    visible: bool,
) -> Result<(Style, u64), crate::expression::vm::VmError> {
    let (display_tag, display) = if !visible {
        (0u8, Display::None)
    } else {
        match lp.display {
            crate::normalize::ir::LayoutDisplayIR::None => (0u8, Display::None),
            crate::normalize::ir::LayoutDisplayIR::Flex => (1u8, Display::Flex),
            crate::normalize::ir::LayoutDisplayIR::Grid => (2u8, Display::Grid),
        }
    };

    let (position_tag, position) = match lp.position {
        crate::normalize::ir::LayoutPositionIR::Relative => (0u8, Position::Relative),
        crate::normalize::ir::LayoutPositionIR::Absolute => (1u8, Position::Absolute),
    };

    let (flex_direction_tag, flex_direction) = match lp.direction {
        crate::normalize::ir::LayoutDirectionIR::Row => (0u8, FlexDirection::Row),
        crate::normalize::ir::LayoutDirectionIR::Column => (1u8, FlexDirection::Column),
    };
    let (flex_wrap_tag, flex_wrap) = match lp.wrap {
        crate::normalize::ir::LayoutWrapIR::NoWrap => (0u8, FlexWrap::NoWrap),
        crate::normalize::ir::LayoutWrapIR::Wrap => (1u8, FlexWrap::Wrap),
    };

    let (justify_tag, justify_content) = match lp.justify_content {
        crate::normalize::ir::LayoutJustifyContentIR::Start => (0u8, JustifyContent::Start),
        crate::normalize::ir::LayoutJustifyContentIR::End => (1u8, JustifyContent::End),
        crate::normalize::ir::LayoutJustifyContentIR::Center => (2u8, JustifyContent::Center),
        crate::normalize::ir::LayoutJustifyContentIR::SpaceBetween => {
            (3u8, JustifyContent::SpaceBetween)
        }
        crate::normalize::ir::LayoutJustifyContentIR::SpaceAround => {
            (4u8, JustifyContent::SpaceAround)
        }
        crate::normalize::ir::LayoutJustifyContentIR::SpaceEvenly => {
            (5u8, JustifyContent::SpaceEvenly)
        }
    };
    let (align_items_tag, align_items) = match lp.align_items {
        crate::normalize::ir::LayoutAlignItemsIR::Start => (0u8, AlignItems::Start),
        crate::normalize::ir::LayoutAlignItemsIR::End => (1u8, AlignItems::End),
        crate::normalize::ir::LayoutAlignItemsIR::Center => (2u8, AlignItems::Center),
        crate::normalize::ir::LayoutAlignItemsIR::Stretch => (3u8, AlignItems::Stretch),
    };
    let (align_content_tag, align_content) = match lp.align_content {
        crate::normalize::ir::LayoutAlignContentIR::Start => (0u8, AlignContent::Start),
        crate::normalize::ir::LayoutAlignContentIR::End => (1u8, AlignContent::End),
        crate::normalize::ir::LayoutAlignContentIR::Center => (2u8, AlignContent::Center),
        crate::normalize::ir::LayoutAlignContentIR::SpaceBetween => {
            (3u8, AlignContent::SpaceBetween)
        }
        crate::normalize::ir::LayoutAlignContentIR::SpaceAround => (4u8, AlignContent::SpaceAround),
        crate::normalize::ir::LayoutAlignContentIR::SpaceEvenly => (5u8, AlignContent::SpaceEvenly),
        crate::normalize::ir::LayoutAlignContentIR::Stretch => (6u8, AlignContent::Stretch),
    };
...
fn sample_dimension_tag_and_value(
    ...
    frame: u64,
    props: Option<&PropertyValues>,
) -> Result<(u64, Dimension), crate::expression::vm::VmError> {
    Ok(match d {
...
fn sample_lane_f64(
    ...
    frame: u64,
    props: Option<&PropertyValues>,
) -> Result<f64, crate::expression::vm::VmError> {
    match a {
        ...
        Anim::Reference(pid) => {
            let Some(props) = props else {
                return Err(crate::expression::vm::VmError::new(
