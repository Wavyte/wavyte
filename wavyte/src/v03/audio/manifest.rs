...
use crate::v03::audio::mix::frame_to_sample;
...
use crate::v03::normalize::ir::{AssetIR, CollectionModeIR, CompositionIR, NodeKindIR};
...
fn ensure_video_probe(
    interner: &StringInterner,
    assets_root: &Path,
    source: crate::v03::normalize::intern::InternId,
    asset: AssetIdx,
