...
- `compile_frame_with_cache(comp, eval, assets, cache)` (crate-internal hot path):
  ...
  - for each evaluated node:
    - parse effects through cache (`parse_effect_cached`) to avoid repeat JSON parse work.
  ...
  - transition composition stage:
    - parses transitions through cache (`parse_transition_cached`).
...
src/audio/mix.rs:161:pub fn write_mix_to_f32le_file(samples_interleaved: &[f32], out_path: &Path) -> WavyteResult<()> {
src/audio/mix.rs:183:fn fade_gain(seg: &AudioSegment, rel_sec: f64, seg_len_samples: u64, sample_rate: u32) -> f32 {
src/audio/mix.rs:198:fn push_audio_segment(
src/audio/mix.rs:236:fn push_video_audio_segment(
src/audio/mix.rs:278:fn push_segment_common(
src/audio/mix.rs:321:pub fn frame_to_sample(frame_delta: u64, fps: Fps, sample_rate: u32) -> u64 {
src/audio/mix.rs:327:fn intersect_ranges(a: FrameRange, b: FrameRange) -> Option<FrameRange> {
src/audio/mix.rs:341:    fn frame_to_sample_uses_rational_fps() {
src/audio/mix.rs:348:    fn mix_applies_overlap_and_fades() {
...
src/render/composite.rs:5:pub type PremulRgba8 = [u8; 4];
src/render/composite.rs:7:pub fn over(dst: PremulRgba8, src: PremulRgba8, opacity: f32) -> PremulRgba8 {
src/render/composite.rs:32:pub fn crossfade(a: PremulRgba8, b: PremulRgba8, t: f32) -> PremulRgba8 {
src/render/composite.rs:46:pub fn over_in_place(dst: &mut [u8], src: &[u8], opacity: f32) -> WavyteResult<()> {
src/render/composite.rs:59:pub fn crossfade_over_in_place(dst: &mut [u8], a: &[u8], b: &[u8], t: f32) -> WavyteResult<()> {
src/render/composite.rs:77:pub fn wipe_over_in_place(
src/render/composite.rs:143:pub struct WipeParams {
src/render/composite.rs:151:fn mul_div255(x: u16, y: u16) -> u8 {
src/render/composite.rs:155:fn add_sat_u8(a: u8, b: u8) -> u8 {
src/render/composite.rs:159:fn smoothstep(a: f32, b: f32, x: f32) -> f32 {
src/render/composite.rs:175:    fn over_opacity_0_is_noop() {
src/render/composite.rs:182:    fn over_src_alpha_0_is_noop() {
src/render/composite.rs:189:    fn over_src_opaque_replaces_dst() {
src/render/composite.rs:196:    fn over_dst_transparent_returns_scaled_src() {
src/render/composite.rs:203:    fn crossfade_t_0_is_a_and_t_1_is_b() {
src/render/composite.rs:211:    fn wipe_ltr_endpoints_match_a_and_b() {
src/render/composite.rs:253:    fn wipe_ltr_midpoint_splits_image() {
src/render/composite.rs:280:    fn wipe_soft_edge_blends_near_boundary() {
src/render/composite.rs:310:    fn wipe_negative_soft_edge_is_treated_as_zero() {
...
src/render/cpu.rs:36:impl VideoFrameDecoder {
src/render/cpu.rs:37:    fn new(info: std::sync::Arc<media::VideoSourceInfo>) -> Self {
src/render/cpu.rs:57:    fn decode_at(&mut self, source_time_s: f64) -> WavyteResult<vello_cpu::Image> {
src/render/cpu.rs:78:    fn key_for_time(&self, source_time_s: f64) -> u64 {
src/render/cpu.rs:82:    fn prefetch_for_key(&mut self, key_ms: u64) -> WavyteResult<()> {
src/render/cpu.rs:108:    fn rgba_to_image(&self, rgba: &[u8]) -> WavyteResult<vello_cpu::Image> {
src/render/cpu.rs:116:    fn insert_frame(&mut self, key: u64, image: vello_cpu::Image) {
src/render/cpu.rs:126:    fn touch(&mut self, key: u64) {
src/render/cpu.rs:134:impl CpuBackend {
src/render/cpu.rs:135:    pub fn new(settings: RenderSettings) -> Self {
src/render/cpu.rs:147:impl PassBackend for CpuBackend {
src/render/cpu.rs:148:    fn ensure_surface(&mut self, id: SurfaceId, desc: &SurfaceDesc) -> WavyteResult<()> {
src/render/cpu.rs:195:    fn exec_scene(
src/render/cpu.rs:221:    fn exec_offscreen(
src/render/cpu.rs:266:    fn exec_composite(
src/render/cpu.rs:351:    fn readback_rgba8(
src/render/cpu.rs:376:impl RenderBackend for CpuBackend {
src/render/cpu.rs:377:    fn worker_render_settings(&self) -> Option<RenderSettings> {
src/render/cpu.rs:382:fn premul_rgba8(r: u8, g: u8, b: u8, a: u8) -> [u8; 4] {
src/render/cpu.rs:388:fn clear_pixmap(pixmap: &mut vello_cpu::Pixmap, rgba: [u8; 4]) {
src/render/cpu.rs:395:fn draw_op(
src/render/cpu.rs:544:fn affine_to_cpu(a: crate::core::Affine) -> vello_cpu::kurbo::Affine {
src/render/cpu.rs:548:fn point_to_cpu(p: crate::core::Point) -> vello_cpu::kurbo::Point {
src/render/cpu.rs:552:fn bezpath_to_cpu(path: &crate::core::BezPath) -> vello_cpu::kurbo::BezPath {
src/render/cpu.rs:570:fn image_premul_bytes_to_pixmap(
src/render/cpu.rs:608:fn image_paint_size(image: &vello_cpu::Image) -> WavyteResult<(f64, f64)> {
src/render/cpu.rs:617:impl CpuBackend {
src/render/cpu.rs:618:    fn image_paint_for(
src/render/cpu.rs:643:    fn font_for_text_asset(
src/render/cpu.rs:663:    fn svg_paint_for(
src/render/cpu.rs:696:    fn video_paint_for(
src/render/encode_ffmpeg.rs:15:pub struct EncodeConfig {
src/render/encode_ffmpeg.rs:25:pub struct AudioInputConfig {
src/render/encode_ffmpeg.rs:31:impl EncodeConfig {
src/render/encode_ffmpeg.rs:33:    pub fn validate(&self) -> WavyteResult<()> {
src/render/encode_ffmpeg.rs:64:    pub fn with_out_path(mut self, out_path: impl Into<PathBuf>) -> Self {
src/render/encode_ffmpeg.rs:71:pub fn default_mp4_config(
src/render/encode_ffmpeg.rs:88:pub fn is_ffmpeg_on_path() -> bool {
src/render/encode_ffmpeg.rs:99:pub fn ensure_parent_dir(path: &Path) -> WavyteResult<()> {
src/render/encode_ffmpeg.rs:113:pub struct FfmpegEncoder {
src/render/encode_ffmpeg.rs:122:impl FfmpegEncoder {
src/render/encode_ffmpeg.rs:124:    pub fn new(cfg: EncodeConfig, bg_rgba: [u8; 4]) -> WavyteResult<Self> {
src/render/encode_ffmpeg.rs:237:    pub fn encode_frame(&mut self, frame: &FrameRGBA) -> WavyteResult<()> {
src/render/encode_ffmpeg.rs:273:    pub fn finish(mut self) -> WavyteResult<()> {
src/render/encode_ffmpeg.rs:300:fn flatten_to_opaque_rgba8(
src/render/encode_ffmpeg.rs:349:fn mul_div255(x: u16, y: u16) -> u16 {
src/render/encode_ffmpeg.rs:358:    fn config_validation_catches_bad_values() {
src/render/encode_ffmpeg.rs:400:    fn flatten_premul_over_black_produces_expected_rgb() {
src/render/encode_ffmpeg.rs:409:    fn flatten_straight_over_black_produces_expected_rgb() {
...
src/render/compile.rs:14:struct EffectCacheKey {
src/render/compile.rs:20:struct TransitionCacheKey {
src/render/compile.rs:41:pub struct RenderPlan {
src/render/compile.rs:50:pub enum Pass {
src/render/compile.rs:58:pub struct ScenePass {
src/render/compile.rs:66:pub struct SurfaceId(pub u32);
src/render/compile.rs:70:pub enum PixelFormat {
src/render/compile.rs:76:pub struct SurfaceDesc {
src/render/compile.rs:84:pub struct OffscreenPass {
src/render/compile.rs:92:pub struct CompositePass {
src/render/compile.rs:99:pub enum CompositeOp {
src/render/compile.rs:120:pub enum DrawOp {
src/render/compile.rs:160:pub fn compile_frame(
src/render/compile.rs:388:fn parse_effect_cached(
src/render/compile.rs:411:fn parse_transition_cached(
src/render/compile.rs:447:    fn store_for(comp: &Composition) -> PreparedAssetStore {
src/render/compile.rs:452:    fn compile_path_emits_fillpath_without_asset_cache() {
src/render/compile.rs:517:    fn compile_applies_inline_effects_to_opacity_and_transform() {
src/render/compile.rs:590:    fn compile_emits_offscreen_blur_pass_and_composites_blurred_surface() {
src/render/compile.rs:681:    fn compile_pairs_crossfade_into_single_composite_op() {
src/render/compile.rs:767:    fn compile_pairs_wipe_into_single_composite_op() {
src/render/compile.rs:861:    fn compile_does_not_pair_transitions_when_progress_is_not_aligned() {
src/render/pipeline.rs:27:pub fn render_frame(
src/render/pipeline.rs:44:pub fn render_frames(
src/render/pipeline.rs:55:pub struct RenderThreading {
src/render/pipeline.rs:62:impl Default for RenderThreading {
src/render/pipeline.rs:63:    fn default() -> Self {
src/render/pipeline.rs:74:pub struct RenderStats {
src/render/pipeline.rs:80:pub fn render_frames_with_stats(
src/render/pipeline.rs:146:pub struct RenderToMp4Opts {
src/render/pipeline.rs:157:impl Default for RenderToMp4Opts {
src/render/pipeline.rs:158:    fn default() -> Self {
src/render/pipeline.rs:179:pub fn render_to_mp4(
src/render/pipeline.rs:190:pub fn render_to_mp4_with_stats(
src/render/pipeline.rs:327:fn render_chunk_sequential(
src/render/pipeline.rs:353:struct ChunkParallelOut {
src/render/pipeline.rs:359:fn render_chunk_parallel_cpu_unique(
src/render/pipeline.rs:440:fn render_chunk_parallel_cpu(
src/render/pipeline.rs:492:fn build_thread_pool(threads: Option<usize>) -> WavyteResult<rayon::ThreadPool> {
src/render/pipeline.rs:510:fn normalized_chunk_size(chunk_size: usize) -> u64 {
src/render/pipeline.rs:518:struct TempFileGuard(Option<std::path::PathBuf>);
src/render/pipeline.rs:520:impl Drop for TempFileGuard {
src/render/pipeline.rs:521:    fn drop(&mut self) {
...
src/render/fingerprint.rs:129:    fn comp_with_opacity(opacity: f64) -> Composition {
src/render/fingerprint.rs:172:    fn fingerprint_is_deterministic_for_same_eval() {
src/render/fingerprint.rs:181:    fn fingerprint_changes_when_scene_changes() {
...
src/composition/model.rs:120:pub enum Asset {
src/composition/model.rs:130:pub struct TextAsset {
src/composition/model.rs:140:fn default_text_color_rgba8() -> [u8; 4] {
src/composition/model.rs:145:pub struct SvgAsset {
src/composition/model.rs:150:pub struct PathAsset {
src/composition/model.rs:155:pub struct ImageAsset {
src/composition/model.rs:160:pub struct VideoAsset {
src/composition/model.rs:179:pub struct AudioAsset {
src/composition/model.rs:197:fn default_playback_rate() -> f64 {
src/composition/model.rs:201:fn default_volume() -> f64 {
src/composition/model.rs:206:pub struct EffectInstance {
src/composition/model.rs:213:pub struct TransitionSpec {
src/composition/model.rs:221:impl Composition {
src/composition/model.rs:222:    pub fn validate(&self) -> WavyteResult<()> {
src/composition/model.rs:352:fn validate_rel_source(source: &str, field: &str) -> WavyteResult<()> {
src/composition/model.rs:374:fn validate_media_controls(
src/composition/model.rs:418:impl TransitionSpec {
src/composition/model.rs:419:    pub fn validate(&self) -> WavyteResult<()> {
src/composition/model.rs:442:    fn basic_comp() -> Composition {
src/composition/model.rs:502:    fn json_roundtrip() {
src/composition/model.rs:511:    fn validate_rejects_missing_asset() {
src/composition/model.rs:518:    fn validate_rejects_out_of_bounds_range() {
src/composition/model.rs:528:    fn validate_rejects_bad_fps() {
src/composition/model.rs:535:    fn media_assets_serde_defaults_and_validation() {
src/composition/model.rs:560:    fn media_validation_rejects_non_positive_playback_rate() {
...
src/composition/eval.rs:66:    fn eval_frame_with_layout_impl(
src/composition/eval.rs:111:fn eval_clip(
src/composition/eval.rs:159:fn resolve_effect(e: &EffectInstance) -> WavyteResult<ResolvedEffect> {
src/composition/eval.rs:169:fn resolve_transition_in(clip: &Clip, frame: FrameIndex) -> Option<ResolvedTransition> {
src/composition/eval.rs:180:fn resolve_transition_out(clip: &Clip, frame: FrameIndex) -> Option<ResolvedTransition> {
src/composition/eval.rs:186:enum TransitionEdge {
src/composition/eval.rs:191:fn resolve_transition_window(
src/composition/eval.rs:241:fn stable_hash64(seed: u64, s: &str) -> u64 {
src/composition/eval.rs:262:    fn basic_comp(
src/composition/eval.rs:318:    fn visibility_respects_frame_range() {
src/composition/eval.rs:351:    fn opacity_is_clamped() {
src/composition/eval.rs:359:    fn transition_progress_boundaries() {
...
src/assets/store.rs:18:pub struct PreparedImage {
src/assets/store.rs:25:pub struct PreparedSvg {
src/assets/store.rs:30:pub struct TextBrushRgba8 {
src/assets/store.rs:38:pub struct PreparedText {
src/assets/store.rs:44:impl std::fmt::Debug for PreparedText {
src/assets/store.rs:45:    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
src/assets/store.rs:55:pub struct PreparedPath {
src/assets/store.rs:60:pub struct PreparedAudio {
src/assets/store.rs:67:pub struct PreparedVideo {
src/assets/store.rs:73:pub enum PreparedAsset {
src/assets/store.rs:83:pub struct AssetId(pub(crate) u64);
src/assets/store.rs:85:impl AssetId {
src/assets/store.rs:86:    pub fn from_u64(raw: u64) -> Self {
src/assets/store.rs:90:    pub fn as_u64(self) -> u64 {
src/assets/store.rs:96:pub struct AssetKey {
src/assets/store.rs:101:impl AssetKey {
src/assets/store.rs:102:    pub fn new(norm_path: String, mut params: Vec<(String, String)>) -> Self {
src/assets/store.rs:109:pub struct PreparedAssetStore {
src/assets/store.rs:115:impl PreparedAssetStore {
src/assets/store.rs:116:    pub fn prepare(comp: &model::Composition, root: impl Into<PathBuf>) -> WavyteResult<Self> {
src/assets/store.rs:207:    pub fn root(&self) -> &Path {
src/assets/store.rs:211:    pub fn id_for_key(&self, key: &str) -> WavyteResult<AssetId> {
src/assets/store.rs:218:    pub fn get(&self, id: AssetId) -> WavyteResult<&PreparedAsset> {
src/assets/store.rs:224:    fn key_for(&self, asset: &model::Asset) -> WavyteResult<(u8, AssetKey)> {
src/assets/store.rs:272:    fn hash_id_for_key(kind_tag: u8, key: &AssetKey) -> AssetId {
src/assets/store.rs:286:    fn read_bytes(&self, norm_path: &str) -> WavyteResult<Vec<u8>> {
src/assets/store.rs:294:fn parse_svg_with_options(root: &Path, norm_path: &str, bytes: &[u8]) -> WavyteResult<PreparedSvg> {
src/assets/store.rs:313:fn build_svg_fontdb(
src/assets/store.rs:331:fn load_fonts_from_dir(db: &mut usvg::fontdb::Database, dir: &Path) {
src/assets/store.rs:352:fn make_svg_font_resolver() -> usvg::FontResolver<'static> {
src/assets/store.rs:407:pub fn normalize_rel_path(source: &str) -> WavyteResult<String> {
src/assets/store.rs:436:fn parse_svg_path(d: &str) -> WavyteResult<BezPath> {
src/assets/store.rs:447:pub struct TextLayoutEngine {
src/assets/store.rs:453:impl Default for TextLayoutEngine {
src/assets/store.rs:454:    fn default() -> Self {
src/assets/store.rs:459:impl TextLayoutEngine {
src/assets/store.rs:460:    pub fn new() -> Self {
src/assets/store.rs:468:    pub fn last_family_name(&self) -> Option<String> {
src/assets/store.rs:472:    pub fn layout_plain(
src/assets/store.rs:535:    fn normalize_path_slash_normalization() {
src/assets/store.rs:543:    fn asset_id_stability_same_input() {
src/assets/store.rs:559:    fn prepare_path_assets_without_external_io() {
src/assets/store.rs:590:    fn text_layout_smoke_with_local_font_if_present() {
src/assets/store.rs:616:    fn prepare_single_image_asset() {
...
src/foundation/math.rs:4:impl Fnv1a64 {
src/foundation/math.rs:51:    fn fnv_seeded_hash_is_stable() {
src/foundation/math.rs:61:    fn mul_div255_variants_align() {
...
src/assets/media.rs:213:pub fn decode_video_frame_rgba8(
src/assets/media.rs:234:pub fn decode_audio_f32_stereo(path: &Path, sample_rate: u32) -> WavyteResult<AudioPcm> {
src/assets/media.rs:294:pub fn decode_audio_f32_stereo(_path: &Path, _sample_rate: u32) -> WavyteResult<AudioPcm> {
src/assets/media.rs:301:fn parse_ff_ratio(s: &str) -> Option<(u32, u32)> {
src/assets/media.rs:316:    fn source_time_mapping_applies_trim_and_rate() {
